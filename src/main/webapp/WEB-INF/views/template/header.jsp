...
<div class="navbar-wrapper">
    <div class="container">
        ...
        <div style="background-color:pink;color:powderblue;padding:1px;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<c:url value="/" /> ">FAB</a>
                </div>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <!--  <li style="color=red"> <img src="<c:url value="/resources/images/img22.jpg" />" ></li>
                -->
